...
theorem geometric_of_FEq_negated
...
-/
theorem Umechstat_identity_negated
    (w : ℕ) (T β ε : ℝ) :
  ...
  apply ne_of_gt
  exact add_pos_of_pos_of_nonneg zero_lt_one (Real.exp_nonneg (-1))
